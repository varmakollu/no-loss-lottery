...
// time flies
// withdraw time: 1005 aDAI --> (990 scaledBalance * index = 1005 aDAI) --- 1000 DAI principal, 1005 aDAI - 1000 = 5 aDAI interest
contract AaveLottery {
    ...
    IERC20 public underlying; // assest
    ...
    constructor(uint256 _roundDuration, address _underlying, address _aavePool) {
        ...
        require(data.aTokenAddress != address(0), "ATOKEN_NOT_EXIST");
    ...
    function enter(uint256 amount) external {
        // Checks
        require(tickets[currentId][msg.sender].stake == 0, "USER_ALREADY_PARTICIPANT");
        // Update
        _updateState();
        // User enters
        // [totalStake, totalStrike + amount]
    ...
    function exit(uint256 roundId) external {
        ...
        // Update
        _updateState();
        require(roundId < currentId, "CURRENT_LOTTERY"); // Fixed the missing semicolon here
        // User exits
